...
@Component({
  selector: 'app-user-courseforum',
  templateUrl: './user-courseforum.component.html',
  styleUrls: ['./user-courseforum.component.css']
})
export class UserCourseforumComponent implements OnInit {
